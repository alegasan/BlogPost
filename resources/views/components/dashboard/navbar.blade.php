<div class="mx-auto">
    <header class="rounded-3xl border border-[#d7d1c6] bg-[#fffdf7] px-6 py-4">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="space-y-1">
                <a href="{{ url('/') }}"
                    class="text-2xl tracking-wide text-[#12211b] [font-family:'DM_Serif_Display',serif]">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <x-ui.button type="submit" variant="text" size="sm"
                        class="text-[#5f6f68] hover:text-[#1f2b26] cursor-pointer">
                        Logout
                    </x-ui.button>
                </form>
            </div>
